 ...
 */
public final class RGBLuminanceSources extends LuminanceSource
{

    private final byte[] luminances;

    public RGBLuminanceSources(String path) throws FileNotFoundException
    {
        this(loadBitmap(path));
    }

    public RGBLuminanceSources(Bitmap bitmap)
    {
