...
public class KeyServerQueryActivity extends SherlockFragmentActivity {
    ...
    private void start() {
        ...
        data.putString(KeyIntentService.QUERY_KEY_SERVER, server);

        data.putInt(KeyIntentService.QUERY_KEY_TYPE, mQueryType);

        if (mQueryType == Id.keyserver.search) {
            data.putString(KeyIntentService.QUERY_KEY_STRING, mQueryString);
        } else if (mQueryType == Id.keyserver.get) {
            data.putLong(KeyIntentService.QUERY_KEY_ID, mQueryId);
        }
    ...
    public class KeyInfoListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View view = mInflater.inflate(R.layout.key_server_query_result, null);
