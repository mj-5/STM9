...
//    private Bitmap icon = mImage;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (mEncryptToClipboardEnabled) {
            menu.add(1, Id.menu.opsi.encrypt_to_clipboard, 0, mEncryptToClipboardString)
                    .setShowAsAction(
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case Id.menu.opsi.encrypt_to_clipboard:
    ...
    private void updateActionBarButtons() {
        switch (mSource.getCurrentView().getId()) {
        case R.id.sourceFile: {
            setActionbarButtons(true, R.string.tmbl_encrypt_file, false, 0);
        ...
        case R.id.sourceMessage: {
            ...
            if (mMode.getCurrentView().getId() == R.id.modeSymmetric) {
                setActionbarButtons(true, R.string.tmbl_encrypt_and_send, true,
                        R.string.tmbl_encrypt_to_clipboard);
            } else {
                if (mEncryptionKeyIds == null || mEncryptionKeyIds.length == 0) {
                    if (mSecretKeyId == 0) {
                        setActionbarButtons(false, 0, false, 0);
                    } else {
                        setActionbarButtons(true, R.string.tmbl_sign_and_send, true,
                                R.string.tmbl_sign_to_clipboard);
                    }
                } else {
                    setActionbarButtons(true, R.string.tmbl_encrypt_and_send, true,
                            R.string.tmbl_encrypt_to_clipboard);
            ...
            public void handleMessage(Message message) {
                ...
                if (message.arg1 == KeyIntentServiceHandler.MESSAGE_OKAY) {
                    ...
                    case Id.target.clipboard:
                        ...
                        ClipboardReflection.copyToClipboard(EncSignActivity.this, output);
                        Toast.makeText(EncSignActivity.this,
...
//                        sendIntent.putExtra(Intent.EXTRA_STREAM, Uri.parse(Environment.getExternalStorageDirectory() + "temporary_file.jpg"));
                    ...
                    case Id.target.file:
                        Toast.makeText(EncSignActivity.this, R.string.encryption_successful,
                                Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mSourcePrevious.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                mSource.setInAnimation(AnimationUtils.loadAnimation(EncSignActivity.this,
                		R.anim.push_right_in));
                mSource.setOutAnimation(AnimationUtils.loadAnimation(EncSignActivity.this,
        ...
        mModePrevious.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                mMode.setInAnimation(AnimationUtils.loadAnimation(EncSignActivity.this,
                        R.anim.push_right_in));
                mMode.setOutAnimation(AnimationUtils.loadAnimation(EncSignActivity.this,
                        R.anim.push_right_out));
                mMode.showPrevious();
                updateMode();
            }
        ...
        mBrowse.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                FileHelper.openFile(EncSignActivity.this, mFilename.getText().toString(), "*/*",
                        Id.request.filename);
            }
        });
        ...
        Choice[] choices = new Choice[] {
        		new Choice(Id.pilihan.compression.none, getString(R.string.choice_none) + " ("
